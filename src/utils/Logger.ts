...
export default {
    info: function (contents: any, thread: 'Server' | 'Client' | 'Shard' = 'Server') {
        console.log(`${timestamp(thread, chalk.black.bgWhite('INFO'))} : ${contents}`);
    },
    error: function (contents: any, thread: 'Server' | 'Client' | 'Shard' = 'Server') {
        console.log(`${timestamp(thread, chalk.black.bgRed('ERROR'))} : ${contents}`);
    },
    warn: function (contents: any, thread: 'Server' | 'Client' | 'Shard' = 'Server') {
        console.log(`${timestamp(thread, chalk.black.bgYellow('WARNING'))} : ${contents}`);
    },
    debug: function (contents: any, thread: 'Server' | 'Client' | 'Shard' = 'Server') {
